                    ...
                    child: MouseRegion(
                      ...
                      child: Tooltip(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            // Menampilkan kata yang diklik saat diklik
                            ScaffoldMessenger.of(context)
                              ..hideCurrentSnackBar()
                              ..showSnackBar(
                                SnackBar(
                                  content: Text('Word is: ${wp.asPascalCase}'),
                                ),
                              );
                          },
                        ),
